...
public class tela_usuario_editarperfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_usuario_editarperfil);

        this.setTitle("PR-Imoveisbeta - Editando perfil");

        txt_nome_edita = (EditText) findViewById(R.id.txt_nome_editaruser);
        txt_email_edita = (EditText) findViewById(R.id.txt_email_editaruser);
        txt_cpf_edita = (EditText) findViewById(R.id.txt_cpf_editaruser);
        txt_telefone_edita = (EditText) findViewById(R.id.txt_telefone_editarperfil);
        txt_celular_edita = (EditText) findViewById(R.id.txt_celular_editarperfil);
    ...
    public void abrirurl(View view) {
        ...
        Uri uri = Uri.parse("https://www.ctbarmc-imobiliariabeta.com.br/loginesqsenha");
    ...
    private class SolicitaDados extends AsyncTask<String, Void, String> {
        ...
        public void ClicarEditarPerfilUser(View view) {
